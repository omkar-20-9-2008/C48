...
function preload(){
  ...
  Day = loadImage("n1.png");
  Night=loadImage("d1.png");

}
function setup() {
  createCanvas(800,600);

  day = createSprite(400,300,800,600);
  day.addImage("day",Day);
  
  night = createSprite(400,-300,800,600);
  night.addImage("night",Night);
  ...
  rect6.shapeColor=rgb(128,128,128);

  line1 = createSprite(350,60,5,50);
  line1.shapeColor =rgb(128,128,128);
  
  line2 = createSprite(410,37.5,120,5);
  line2.shapeColor =rgb(128,128,128);

  line3 = createSprite(470,60,5,50);
  line3.shapeColor =rgb(128,128,128);

  line4 = createSprite(410,82.5,120,5);
  line4.shapeColor =rgb(128,128,128);

  line5 = createSprite(374,60,5,50);
  line5.shapeColor =rgb(128,128,128);

  line6 = createSprite(398,60,5,50);
  line6.shapeColor =rgb(128,128,128);

  line7 = createSprite(422,60,5,50);
  line7.shapeColor =rgb(128,128,128);
  
  line8 = createSprite(446,60,5,50);
  line8.shapeColor =rgb(128,128,128);
